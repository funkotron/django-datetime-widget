...
!function ($) {
	...
	var Datetimepicker = function (element, options) {
		...
		this.componentReset = this.element.is('.date') ? ( this.bootcssVer == 3 ? this.element.find('.input-group-addon .icon-eraser').parent() : this.element.find('.add-on .icon-eraser').parent()) : false;
	...
	var DPGlobal = {
		...
		headTemplateV3:   '<thead>' +
							  '<tr>' +
							  '<th class="prev"><span class="icon icon-arrow-left"></span> </th>' +
							  '<th colspan="5" class="switch"></th>' +
							  '<th class="next"><span class="icon icon-arrow-right"></span> </th>' +
							  '</tr>' +
			'</thead>',
